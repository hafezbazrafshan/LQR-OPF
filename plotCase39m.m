...
SubFigHandle.TickLabelInterpreter='latex';
 ...
 cd('Figures'); 
  print -dpdf Case39_LQROPF_alphapoint8_LQR_m.pdf
print -depsc2 Case39_LQROPF_alphapoint8_LQR_m
cd('..');
...
SubFigHandle.TickLabelInterpreter='latex';
 ...
 cd('Figures'); 
  print -dpdf Case39_ALQROPF_alphapoint8_LQR_m.pdf
print -depsc2 Case39_ALQROPF_alphapoint8_LQR_m
cd('..');
...
SubFigHandle.TickLabelInterpreter='latex';
 ...
 cd('Figures'); 
  print -dpdf Case39_OPF_alphapoint8_LQR_m.pdf
print -depsc2 Case39_OPF_alphapoint8_LQR_m
cd('..');
