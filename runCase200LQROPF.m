...
SaveName=['Case200LQROPFSteadyStateProgressReport',num2str(Alpha*100),'Percent.txt'];
...
SaveName=['Case200LQROPFDynamicalProgressReport',num2str(Alpha*100),'Percent.txt'];
FileID=fopen(['Results/',SaveName],'w'); 
