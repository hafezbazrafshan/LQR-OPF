function [vgS,pgSNonSlack, thetaSSlack, CompTime,K,SsCost, Gamma,...
  RiccatiSVec,KVec, SsCostVec,GammaVec,TrCostEstimateVec,ObjValue, ItSuccess] = ...
    augmentedOPFAlternatingMinimization( delta0, omega0, e0, m0,...
    v0,theta0, pg0, qg0, ...
    pref0, f0,...
    NetworkS,...
    DeltaPloadg,DeltaQloadg,DeltaPloadl,DeltaQloadl, Alpha)
