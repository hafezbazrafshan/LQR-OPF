...
axis(FigHandle,[0 TFinal FreqyMin-FreqyOffSet FreqyMax+FreqyOffSet+0.01]);
yticks(FigHandle,floor(FreqyMin*100./5)*0.05:0.05:ceil(FreqyMax*100./5)*0.05);
...
FigHandle.TickLabelInterpreter='latex';
axis(FigHandle,[0 Tfinal -my-myOffSet my+myOffSet+2]);
yticks(FigHandle,floor(-my):1:ceil(my));
 GenIdx=cellstr(num2str([1:G].'));
 GenText=cellstr(repmat('Gen. ', G,1));
 legendText=string(GenText)+' '+ string(GenIdx);
 lgd=legend(FigHandle,legendText);
...
FigHandle.TickLabelInterpreter='latex';
axis(FigHandle,[0 Tfinal -pgy-pgyOffSet pgy+pgyOffSet+2]);
yticks(FigHandle,floor(-pgy):1:ceil(pgy));
 GenIdx=cellstr(num2str([1:G].'));
 GenText=cellstr(repmat('Gen. ', G,1));
 legendText=string(GenText)+' '+ string(GenIdx);
 lgd=legend(FigHandle,legendText);
...
yticks(FigHandle,floor(eyMin*100/5)*0.05:0.05:ceil(eyMax*100/5)*0.05);
%  GenIdx=cellstr(num2str([1:G].'));
%  GenText=cellstr(repmat('Gen. ', G,1));
%  legendText=string(GenText)+' '+ string(GenIdx);
...
FigHandle.TickLabelInterpreter='latex';
axis(FigHandle,[0 Tfinal fyMin-fyOffSet fyMax+fyOffSet]);
yticks(FigHandle,floor(fyMin*100/5)*0.05-0.05:0.1:ceil(fyMax*100/5)*0.05+0.05);
 GenIdx=cellstr(num2str([1:G].'));
 GenText=cellstr(repmat('Gen. ', G,1));
%  legendText=string(GenText)+' '+ string(GenIdx);
%  lgd=legend(fig_handle,legendText);
...
FigHandle.TickLabelInterpreter='latex';
axis(FigHandle,[0 Tfinal deltayMin-deltayOffSet deltayMax+deltayOffSet]);
yticks(FigHandle,floor(deltayMin./5)*5:5:ceil(deltayMax./5)*5);
%  GenIdx=cellstr(num2str([1:G].'));
%  GenText=cellstr(repmat('Gen. ', G,1));
%  legendText=string(GenText)+' '+ string(GenIdx);
%  lgd=legend(fig_handle,legendText);
...
FigHandle.TickLabelInterpreter='latex';
axis(FigHandle,[0 Tfinal prefyMin-prefyOffSet prefyMax+prefyOffSet+2]);
yticks(FigHandle,floor(prefyMin):1:ceil(prefyMax));
 GenIdx=cellstr(num2str([1:G].'));
 GenText=cellstr(repmat('Gen. ', G,1));
 legendText=string(GenText)+' '+ string(GenIdx);
 lgd=legend(FigHandle,legendText);
...
xlabel('Time (sec)', 'FontWeight','bold');
 ylabel('$\mathbf{v}$ (pu)'); 
FigHandle.TickLabelInterpreter='latex';
axis(FigHandle,[0 Tfinal vyMin-vyOffSet vyMax+vyOffSet]);
yticks(FigHandle,floor(vyMin*100/5)*0.05:0.02:ceil(vyMax*100/5)*0.05);
