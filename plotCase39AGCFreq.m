...
SubFigHandle.TickLabelInterpreter='latex';
 ...
 cd('Figures'); 
  print -dpdf Case39_LQROPF_alphapoint6_AGC_freq.pdf
print -depsc2 Case39_LQROPF_alphapoint6_AGC_freq
cd('..');
...
SubFigHandle.TickLabelInterpreter='latex';
 ...
 cd('Figures'); 
  print -dpdf Case39_ALQROPF_alphapoint6_AGC_freq.pdf
print -depsc2 Case39_ALQROPF_alphapoint6_AGC_freq
cd('..');
...
axis(SubFigHandle,'tight'); 
SubFigHandle.XTick= 0: 1: 5;
SubFigHandle.YTick=59.90:0.04:60.10;
...
SubFigHandle.TickLabelInterpreter='latex';
 ...
 cd('Figures'); 
  print -dpdf Case39_OPF_alphapoint6_AGC_freq.pdf
print -depsc2 Case39_OPF_alphapoint6_AGC_freq
cd('..');