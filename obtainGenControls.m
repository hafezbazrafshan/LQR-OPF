function [m,f]=obtainGenControls( delta,omega,e,vg,thetag,pg,qg,OMEGAS)
...
global DVec XdVec    XprimeVec

m=DVec.*(omega-OMEGAS)+pg; 
f=(XdVec./XprimeVec).*e- ( (XdVec-XprimeVec)./(XprimeVec)).*vg.*cos(delta-thetag);